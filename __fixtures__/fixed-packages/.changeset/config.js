...
const versionOptions = {
  ...
  // An array of arrays that defines packages that are fixed.
  // Linked packages are packages that should be at the same version when any of them gets released.
  // If you've used Lerna to version packages before, this is the same.
  fixed: [["pkg-a", "pkg-b"]]
};
