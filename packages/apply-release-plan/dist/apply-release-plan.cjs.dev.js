...
async function applyReleasePlan(releasePlan, packages, config$1 = config.defaultConfig) {
  ...
  const versionCommit = createReleaseCommit(releasePlan, config$1.commit); // I think this might be the wrong place to do this, but gotta do it somewhere -  add changelog entries to releases
...
exports.getReleasesWithChangelogs = getReleasesWithChangelogs;
