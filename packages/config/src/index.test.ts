...
The \`changelog\` option is set as {} when the only valid values are undefined, a module path or a tuple with a module path and config for the changelog generator"
`);
  });
