...
This option is for setting how private packages should be handled. By default, Changesets will not version or tag private packages. You can configure this option to opt into either behavior.
