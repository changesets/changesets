...
To enable this feature set `privatePackages` to `{ version: true, tag: true }` in your `.changesets/config.json` file. By default Changesets will not version or tag private packages (that is, `{ version: false, tag: false }`).
