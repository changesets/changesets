...
- **pull request author** - Author of a pull request that includes one or more changesets.
- **release manager** - person or process that is responsible for managing a release aka applying changesets then publishing to npm.
