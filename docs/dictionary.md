...
- **fixed packages** - Fixed packages share a semver categorisation, such that all linked packages have consistent new semver ranges and will be published together. The logistics of this are best left to our [./fixed-packages.md] documentation.
